...
extern void csh_led_on(void);
extern void csh_led_off(void);
...
#if 0	//csh
	mt_set_gpio_mode(128, GPIO_MODE_GPIO);
	mt_set_gpio_dir(128, GPIO_DIR_OUT);
	mt_set_gpio_out(128, GPIO_OUT_ONE); 
#else
	csh_led_on();
#endif
...
int FL_disable(void)
{
	...
	mt_set_gpio_mode(128, GPIO_MODE_GPIO);
	mt_set_gpio_dir(128, GPIO_DIR_OUT);
	mt_set_gpio_out(128, GPIO_OUT_ZERO); //csh
#else
	csh_led_off();
#endif
//	upmu_set_flash_en(0);
