 ...
 *20140421 zyy    modify 2.5pll, dry ability V2.0
 *
 *------------------------------------------------------------------------------
...
#if defined(PROJECT_M713_DRV_SUPPORT)||defined(PROJECT_M715_DRV_SUPPORT)
//AE target
#define  SP2519_P1_0xeb  0x78//78//80
#define  SP2519_P1_0xec  0x88//6e//74
//HEQ
#define  SP2519_P1_0x10  0x70 ////ku_outdoor  equal 0xdd of SP2519 //0x80
#define  SP2519_P1_0x11  0x70 //ku indoor  //0x80
#define  SP2519_P1_0x12  0x78 //ku dummy //0x80
#define  SP2519_P1_0x13  0x78 //ku low  //0x80

#define  SP2519_P1_0x14  0x94 //kl outdoor //0xa0
#define  SP2519_P1_0x15  0x94 //kl indoor  //0xa0
#define  SP2519_P1_0x16  0x98// kl dummy //0xa0
#define  SP2519_P1_0x17  0x98 //kl lowlight //0xa0

#else
//AE target
#define  SP2519_P1_0xeb  0x84//78//80
#define  SP2519_P1_0xec  0x94//6e//74
//HEQ
#define  SP2519_P1_0x10  0x70 ////ku_outdoor  equal 0xdd of SP2519 //0x80
#define  SP2519_P1_0x11  0x70 //ku indoor  //0x80
...
#define  SP2519_P1_0x16  0x90// kl dummy //0xa0
#define  SP2519_P1_0x17  0x90 //kl lowlight //0xa0
#endif
...
void SP2519_config_window(kal_uint8 index)
{
	...
	switch(index)
	{
		...
		case WINDOW_SIZE_VGA:
			#if 0
			/*1600*1200 to VGA this is for resize para*/			
			SP2519_write_cmos_sensor(0xfd,0x01);
			SP2519_write_cmos_sensor(0x4a,0x00);
			SP2519_write_cmos_sensor(0x4b,0x04);
			SP2519_write_cmos_sensor(0x4c,0xb0);
 ...
 *
 *************************************************************************/
#if defined(PROJECT_M709_DRV_SUPPORT)
...
#elif defined(PROJECT_M713_DRV_SUPPORT)||defined(PROJECT_M715_DRV_SUPPORT)
void SP2519_night_mode(kal_bool bEnable)
{
	SENSORDB(" SP2519_night_mode\r\n");

	//kal_uint8 SP2519AE_CTRL;
	//SP2519_write_cmos_sensor(0xfd,0x01);
	//SP2519AE_CTRL=SP2519_read_cmos_sensor(0x32);
	//SP2519_write_cmos_sensor(0x32,SP2519AE_CTRL&0xf8);	
	...
	if (bEnable)/*night mode settings*/
	{
       	...
       	if(SP2519_MPEG4_encode_mode == KAL_TRUE) 
		{
			...
			{	                         
				SENSORDB(" video night mode 50hz\r\n");
				 //  video night mode 50hz  2PLL  fix8fps  
				//ae setting
				 ...
				 SP2519_write_cmos_sensor(0x08,0x00); 
				 SP2519_write_cmos_sensor(0x09,0x01); 
				 SP2519_write_cmos_sensor(0x0a,0x22); 
				 SP2519_write_cmos_sensor(0xfd,0x01); 
				 SP2519_write_cmos_sensor(0xf0,0x00); 
			...
			{ 
				SENSORDB(" video night mode 60hz\r\n");                                                   
			    //  video night mode 60hz 2pll  fix 8 fps
				//ae setting
				...
				SP2519_write_cmos_sensor(0x08,0x00);
				SP2519_write_cmos_sensor(0x09,0x01);
				SP2519_write_cmos_sensor(0x0a,0x1b);
				SP2519_write_cmos_sensor(0xfd,0x01);
				SP2519_write_cmos_sensor(0xf0,0x00);
		...
		{   
			...
			{	
				SENSORDB(" capture night mode 50hz\r\n");//3                            
				//capture night mode 50hz 2PLL 8-6fps
				//ae setting
				
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x02);
				SP2519_write_cmos_sensor(0x04,0x58);
				SP2519_write_cmos_sensor(0x05,0x00);
				SP2519_write_cmos_sensor(0x06,0x00);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x00);
				SP2519_write_cmos_sensor(0x09,0x01);
				SP2519_write_cmos_sensor(0x0a,0x16);
				SP2519_write_cmos_sensor(0xfd,0x01);
				SP2519_write_cmos_sensor(0xf0,0x00);
				SP2519_write_cmos_sensor(0xf7,0x64);
				SP2519_write_cmos_sensor(0xf8,0x53);
				SP2519_write_cmos_sensor(0x02,0x10);
				SP2519_write_cmos_sensor(0x03,0x01);
				SP2519_write_cmos_sensor(0x06,0x64);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x01);
				SP2519_write_cmos_sensor(0x09,0x00);
				SP2519_write_cmos_sensor(0xfd,0x02);
				...
				SP2519_write_cmos_sensor(0x3e,0x53);
				SP2519_write_cmos_sensor(0x3f,0x00);
				SP2519_write_cmos_sensor(0x88,0x1e);
				SP2519_write_cmos_sensor(0x89,0x2b);
				SP2519_write_cmos_sensor(0x8a,0x65);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0xbe,0x40);
				SP2519_write_cmos_sensor(0xbf,0x06);
				SP2519_write_cmos_sensor(0xd0,0x40);
				SP2519_write_cmos_sensor(0xd1,0x06);
				SP2519_write_cmos_sensor(0xc9,0x40);
				SP2519_write_cmos_sensor(0xca,0x06);
			...
			{ 
				SENSORDB(" capture night mode 60hz\r\n");  
				//capture night mode 60hz 2PLL 8-6fps
				//ae setting
				
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x01);
				SP2519_write_cmos_sensor(0x04,0xf8);
				SP2519_write_cmos_sensor(0x05,0x00);
				SP2519_write_cmos_sensor(0x06,0x00);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x00);
				SP2519_write_cmos_sensor(0x09,0x01);
				SP2519_write_cmos_sensor(0x0a,0x0c);
				SP2519_write_cmos_sensor(0xfd,0x01);
				SP2519_write_cmos_sensor(0xf0,0x00);
				SP2519_write_cmos_sensor(0xf7,0x54);
				SP2519_write_cmos_sensor(0xf8,0x54);
				SP2519_write_cmos_sensor(0x02,0x14);
				SP2519_write_cmos_sensor(0x03,0x01);
				SP2519_write_cmos_sensor(0x06,0x54);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x01);
				SP2519_write_cmos_sensor(0x09,0x00);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0x3d,0x14);
				SP2519_write_cmos_sensor(0x3e,0x54);
				SP2519_write_cmos_sensor(0x3f,0x00);
				SP2519_write_cmos_sensor(0x88,0x18);
				SP2519_write_cmos_sensor(0x89,0x18);
				SP2519_write_cmos_sensor(0x8a,0x66);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0xbe,0x90);
				SP2519_write_cmos_sensor(0xbf,0x06);
				SP2519_write_cmos_sensor(0xd0,0x90);
				SP2519_write_cmos_sensor(0xd1,0x06);
				SP2519_write_cmos_sensor(0xc9,0x90);
				SP2519_write_cmos_sensor(0xca,0x06);
	...
	else /*normal mode settings*/
	{
        ...
        if (SP2519_MPEG4_encode_mode == KAL_TRUE) 
		{
			...
			{
				SENSORDB(" video normal mode 50hz\r\n");
				//video normal mode 2Pll fix 8fps 50hz
				//ae setting
				 SP2519_write_cmos_sensor(0xfd,0x00); 
				 SP2519_write_cmos_sensor(0x03,0x02); 
				 SP2519_write_cmos_sensor(0x04,0x52); 
			...
			{
				SENSORDB(" video normal mode 60hz\r\n");  
				//video normal mode 2Pll fix 8fps 60hz/
				//ae setting
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x01);
				SP2519_write_cmos_sensor(0x04,0xf2);
		...
		else/*capture normal mode*/
		{
			...
			{
				SENSORDB(" capture normal mode 50hz\r\n");
				//capture normal mode 2pll 8fps 50hz
				 SP2519_write_cmos_sensor(0xfd,0x00); 
				 SP2519_write_cmos_sensor(0x03,0x02); 
				 SP2519_write_cmos_sensor(0x04,0x52); 
				 SP2519_write_cmos_sensor(0x05,0x00); 
			...
			{
				SENSORDB(" capture normal mode 60hz\r\n");
				//capture normal mode 2pll 8fps 60hz
				//ae setting
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x01);
				SP2519_write_cmos_sensor(0x04,0xf2);
	...
	//SP2519_write_cmos_sensor(0xfd,0x01);
	//SP2519_write_cmos_sensor(0x32,SP2519AE_CTRL|0x05);	
...
void SP2519_night_mode(kal_bool bEnable)
{
	...
	if (bEnable)/*night mode settings*/
	{
       	...
       	if(SP2519_MPEG4_encode_mode == KAL_TRUE) 
		{
			...
			{	                         
				SENSORDB(" video night mode 50hz\r\n");
				 //  video night mode 50hz  3PLL  fix10fps  
				//ae setting
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x02);
				SP2519_write_cmos_sensor(0x04,0xe8);
				...
				SP2519_write_cmos_sensor(0x0a,0x12);
				SP2519_write_cmos_sensor(0xfd,0x01);
				SP2519_write_cmos_sensor(0xf0,0x00);
				SP2519_write_cmos_sensor(0xf7,0x7c);
				SP2519_write_cmos_sensor(0xf8,0x67);
			...
			{ 
				SENSORDB(" video night mode 60hz\r\n");                                                   
			    //  video night mode 60hz 3pll  fix 10 fps
				//ae setting
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x02);
				SP2519_write_cmos_sensor(0x04,0x6a);
		...
		{   
			...
			{	
				SENSORDB(" capture night mode 50hz\r\n");//3                            
				//capture night mode 50hz 3PLL 10-6fps
				//ae setting
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x02);
				SP2519_write_cmos_sensor(0x04,0xe8);
			...
			{ 
				SENSORDB(" capture night mode 60hz\r\n");  
				//capture night mode 60hz 3PLL 10-6fps
				//ae setting
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x02);
				SP2519_write_cmos_sensor(0x04,0x6a);
	...
	else /*normal mode settings*/
	{
        ...
        if (SP2519_MPEG4_encode_mode == KAL_TRUE) 
		{
			...
			{
				SENSORDB(" video normal mode 50hz\r\n");
				//video normal mode 3Pll fix 13fps 50hz
				//ae setting
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x03);
				SP2519_write_cmos_sensor(0x04,0xc6);
				SP2519_write_cmos_sensor(0x05,0x00);
				SP2519_write_cmos_sensor(0x06,0x00);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x00);
				SP2519_write_cmos_sensor(0x09,0x00);
				SP2519_write_cmos_sensor(0x0a,0xc4);
				SP2519_write_cmos_sensor(0xfd,0x01);
				SP2519_write_cmos_sensor(0xf0,0x00);
				SP2519_write_cmos_sensor(0xf7,0xa1);
				SP2519_write_cmos_sensor(0xf8,0x86);
				SP2519_write_cmos_sensor(0x02,0x07);
				SP2519_write_cmos_sensor(0x03,0x01);
				SP2519_write_cmos_sensor(0x06,0xa1);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x01);
				SP2519_write_cmos_sensor(0x09,0x00);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0x3d,0x09);
				SP2519_write_cmos_sensor(0x3e,0x86);
				SP2519_write_cmos_sensor(0x3f,0x00);
				SP2519_write_cmos_sensor(0x88,0x2e);
				SP2519_write_cmos_sensor(0x89,0xd2);
				SP2519_write_cmos_sensor(0x8a,0x33);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0xbe,0x67);
				SP2519_write_cmos_sensor(0xbf,0x04);
				SP2519_write_cmos_sensor(0xd0,0x67);
				SP2519_write_cmos_sensor(0xd1,0x04);
				SP2519_write_cmos_sensor(0xc9,0x67);
				SP2519_write_cmos_sensor(0xca,0x04);
			}
			else
			{
				SENSORDB(" video normal mode 60hz\r\n");  
				//video normal mode 3Pll fix 13fps 60hz/
				//ae setting
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x03);
				SP2519_write_cmos_sensor(0x04,0x24);
				SP2519_write_cmos_sensor(0x05,0x00);
				SP2519_write_cmos_sensor(0x06,0x00);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x00);
				SP2519_write_cmos_sensor(0x09,0x00);
				SP2519_write_cmos_sensor(0x0a,0xc5);
				SP2519_write_cmos_sensor(0xfd,0x01);
				SP2519_write_cmos_sensor(0xf0,0x00);
				SP2519_write_cmos_sensor(0xf7,0x86);
				SP2519_write_cmos_sensor(0xf8,0x86);
				SP2519_write_cmos_sensor(0x02,0x09);
				SP2519_write_cmos_sensor(0x03,0x01);
				SP2519_write_cmos_sensor(0x06,0x86);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x01);
				SP2519_write_cmos_sensor(0x09,0x00);
				SP2519_write_cmos_sensor(0xfd,0x02);
				...
				SP2519_write_cmos_sensor(0x3e,0x86);
				SP2519_write_cmos_sensor(0x3f,0x00);
				SP2519_write_cmos_sensor(0x88,0xd2);
				SP2519_write_cmos_sensor(0x89,0xd2);
				SP2519_write_cmos_sensor(0x8a,0x33);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0xbe,0xb6);
				SP2519_write_cmos_sensor(0xbf,0x04);
				SP2519_write_cmos_sensor(0xd0,0xb6);
				SP2519_write_cmos_sensor(0xd1,0x04);
				SP2519_write_cmos_sensor(0xc9,0xb6);
				SP2519_write_cmos_sensor(0xca,0x04);
			}
		}
		else/*capture normal mode*/
		{
			...
			{
				SENSORDB(" capture normal mode 50hz\r\n");
				//capture normal mode 3pll 8-13fps 50hz
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x03);
				SP2519_write_cmos_sensor(0x04,0xc6);
				SP2519_write_cmos_sensor(0x05,0x00);
				...
				SP2519_write_cmos_sensor(0x8a,0x33);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0xbe,0x8c);
				SP2519_write_cmos_sensor(0xbf,0x07);
				SP2519_write_cmos_sensor(0xd0,0x8c);
				SP2519_write_cmos_sensor(0xd1,0x07);
				SP2519_write_cmos_sensor(0xc9,0x8c);
				SP2519_write_cmos_sensor(0xca,0x07);
			}
			else
			{
				SENSORDB(" capture normal mode 60hz\r\n");
				//capture normal mode 3pll 8-13fps 60hz
				//ae setting
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x03);
				SP2519_write_cmos_sensor(0x04,0x24);
				...
				SP2519_write_cmos_sensor(0x8a,0x33);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0xbe,0xda);
				SP2519_write_cmos_sensor(0xbf,0x07);
				SP2519_write_cmos_sensor(0xd0,0xda);
				SP2519_write_cmos_sensor(0xd1,0x07);
				SP2519_write_cmos_sensor(0xc9,0xda);
				SP2519_write_cmos_sensor(0xca,0x07);
                   }
		}
	}
...
{
#if defined(PROJECT_M715_DRV_SUPPORT)
SP2519_write_cmos_sensor(0xfd,0x01);
SP2519_write_cmos_sensor(0x36,0x02);
SP2519_write_cmos_sensor(0xfd,0x00);
SP2519_write_cmos_sensor(0x1c,0x1f);
SP2519_write_cmos_sensor(0x30,0x0c);
...
SP2519_write_cmos_sensor(0xbc,0xb0);
...
SP2519_write_cmos_sensor(0xec,0x88);
...
SP2519_write_cmos_sensor(0xfd,0x02);
SP2519_write_cmos_sensor(0xe8,0x60);
SP2519_write_cmos_sensor(0xec,0x70);
SP2519_write_cmos_sensor(0xe9,0x68);
SP2519_write_cmos_sensor(0xed,0x70);
...
SP2519_write_cmos_sensor(0x73,0x22);
...
SP2519_write_cmos_sensor(0xb4,0xb3);                                                           
...
SP2519_write_cmos_sensor(0xfd,0x01);
SP2519_write_cmos_sensor(0xd3,0xb4);
SP2519_write_cmos_sensor(0xd4,0xb4);
SP2519_write_cmos_sensor(0xd5,0x90);
SP2519_write_cmos_sensor(0xd6,0x90);
SP2519_write_cmos_sensor(0xd7,0xb4);
SP2519_write_cmos_sensor(0xd8,0xb4);
...
SP2519_write_cmos_sensor(0x14,0x94);                     
SP2519_write_cmos_sensor(0x15,0x94);                      
...
SP2519_write_cmos_sensor(0x8f,0x03);
...
#endif
#endif
	SP2519_write_cmos_sensor(0x30,0x00);// 0x40 bit[6]externel clock
#if defined(PROJECT_M713_DRV_SUPPORT)||defined(PROJECT_M715_DRV_SUPPORT)
	SP2519_write_cmos_sensor(0x2f,0x04);//0x09 //0x08
#else
      SP2519_write_cmos_sensor(0x2f,0x08);//0x09 //0x08
#endif
	SP2519_write_cmos_sensor(0x09,0x01);
	SP2519_write_cmos_sensor(0xfd,0x00);
	SP2519_write_cmos_sensor(0x0c,0x55);
	...
	SP2519_write_cmos_sensor(0x21,0x10); //水珠问题需要改成0x08
...
////ae setting 24M 2pll 8-8fps
	...
	SP2519_write_cmos_sensor(0xb8,0x90);  //mean_nr_dummy                               
	SP2519_write_cmos_sensor(0xb9,0x85);
	...
	SP2519_write_cmos_sensor(0x72,0x05);
	SP2519_write_cmos_sensor(0x73,0x25);
	SP2519_write_cmos_sensor(0x74,0xaa);//a6                                                                            
	...
	SP2519_write_cmos_sensor(0xfd,0x02);
#if defined(PROJECT_M709_DRV_SUPPORT)
	SP2519_write_cmos_sensor(0xe8,0x50);
	SP2519_write_cmos_sensor(0xec,0x5c);
	SP2519_write_cmos_sensor(0xe9,0x4c);
	SP2519_write_cmos_sensor(0xed,0x58);
	SP2519_write_cmos_sensor(0xea,0x40);
	SP2519_write_cmos_sensor(0xee,0x40);
	SP2519_write_cmos_sensor(0xeb,0x3c);
	SP2519_write_cmos_sensor(0xef,0x34);
#else
	...
	SP2519_write_cmos_sensor(0x16,0x95);                                                                                     
	//!F                                                                                             
	SP2519_write_cmos_sensor(0xa0,0x99);//8c                                                                         
	SP2519_write_cmos_sensor(0xa1,0xf4);//fa                                                                         
	SP2519_write_cmos_sensor(0xa2,0xf4);//fa                                                                         
	SP2519_write_cmos_sensor(0xa3,0xf4);//ed                                                                         
	SP2519_write_cmos_sensor(0xa4,0x99);//a6                                                                         
	SP2519_write_cmos_sensor(0xa5,0xf4);//ed                                                                         
	SP2519_write_cmos_sensor(0xa6,0xf4);//e7                                                                         
	SP2519_write_cmos_sensor(0xa7,0xda);//f4                                                                         
	SP2519_write_cmos_sensor(0xa8,0xb3);//a6                                                                         
	SP2519_write_cmos_sensor(0xa9,0x3c);//                                                                      
	SP2519_write_cmos_sensor(0xaa,0x33);//33                                                                         
	SP2519_write_cmos_sensor(0xab,0x0f);//0f                                                                         
	//F                                                                                          
#if defined(PROJECT_M709_DRV_SUPPORT)
	SP2519_write_cmos_sensor(0xac,0xa6);//0x8c                                                                                  
#else
	SP2519_write_cmos_sensor(0xac,0x99);//0x8c                                                                                  
#endif
	SP2519_write_cmos_sensor(0xad,0xf4);//0xf4                                                                                  
	SP2519_write_cmos_sensor(0xae,0xf4);//0x00                                                                                  
	SP2519_write_cmos_sensor(0xaf,0xf4);//0xe7                                                                                  
	SP2519_write_cmos_sensor(0xb0,0x99);//0xc0                                                                                  
	SP2519_write_cmos_sensor(0xb1,0xf4);//0xda                                                                                  
	SP2519_write_cmos_sensor(0xb2,0xf4);//0xf4                                                                                  
	SP2519_write_cmos_sensor(0xb3,0xda);//0xcd                                                                                  
#if defined(PROJECT_M709_DRV_SUPPORT)
	SP2519_write_cmos_sensor(0xb4,0xab);//0xc0 
#elif defined(PROJECT_M713_DRV_SUPPORT)||defined(PROJECT_M715_DRV_SUPPORT)
    SP2519_write_cmos_sensor(0xb4,0xa0);//0xc0 

#else
	SP2519_write_cmos_sensor(0xb4,0xb3);//0xc0                                                                                  
#endif
	SP2519_write_cmos_sensor(0xb5,0x3c);//0x0c                                                                                  
	SP2519_write_cmos_sensor(0xb6,0x33);//0x33                                                                                  
	SP2519_write_cmos_sensor(0xb7,0x0f);//0x0f                                                                                  
	...
	SP2519_write_cmos_sensor(0xd5,0x94);
	SP2519_write_cmos_sensor(0xd6,0x94);
#elif defined(PROJECT_M713_DRV_SUPPORT)||defined(PROJECT_M715_DRV_SUPPORT)
	SP2519_write_cmos_sensor(0xfd,0x01);
	SP2519_write_cmos_sensor(0xd3,0xa8);
	SP2519_write_cmos_sensor(0xd4,0xa8);
	SP2519_write_cmos_sensor(0xd5,0x80);
	...
	//sat u                                                                                            
	SP2519_write_cmos_sensor(0xfd,0x01);
	SP2519_write_cmos_sensor(0xd3,0xa0);
	SP2519_write_cmos_sensor(0xd4,0xa0);
	SP2519_write_cmos_sensor(0xd5,0xa0);
	SP2519_write_cmos_sensor(0xd6,0xa0);
#endif
	//sat v     7                                                                                      
#if defined(PROJECT_M709_DRV_SUPPORT)
	SP2519_write_cmos_sensor(0xd7,0xa8);
	SP2519_write_cmos_sensor(0xd8,0xa8);
	SP2519_write_cmos_sensor(0xd9,0x94);
	SP2519_write_cmos_sensor(0xda,0x94);
#elif defined(PROJECT_M713_DRV_SUPPORT)||defined(PROJECT_M715_DRV_SUPPORT)
	SP2519_write_cmos_sensor(0xd7,0xa4);
	SP2519_write_cmos_sensor(0xd8,0xa4);
	SP2519_write_cmos_sensor(0xd9,0x80);
	SP2519_write_cmos_sensor(0xda,0x80);
#else
	SP2519_write_cmos_sensor(0xd7,0xa0);
	SP2519_write_cmos_sensor(0xd8,0xa0);
	SP2519_write_cmos_sensor(0xd9,0xa0);
	SP2519_write_cmos_sensor(0xda,0xa0);
#endif
...
#define FLASH_BV_THRESHOLD 0x50 //0x00-0xf0
...
static void SP2519_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
    ...
    SP2519_write_cmos_sensor(0xfd,0x01);
    NormBr = SP2519_read_cmos_sensor(0xf1); // 0x00-0x

    SENSORDB(" SP2519_FlashTriggerCheck NormBr=%x\n",NormBr);
