...
static void GC2145_Sensor_SVGA(void)
{
	...
	GC2145_write_cmos_sensor(0xfe, 0x00);
       ...
       //GC2145_write_cmos_sensor(0xfe , 0x00);
       //GC2145_write_cmos_sensor(0x17 , 0x14);
...
static void GC2145_Sensor_2M(void)
{
	...
	GC2145_write_cmos_sensor(0xfe , 0x00);
       ...
       //GC2145_write_cmos_sensor(0xfe , 0x00);
       //GC2145_write_cmos_sensor(0x17 , 0x16);
}
...
UINT32 GC2145Open(void)
{
	...
	for(i=0;i<3;i++)
	{
		...
		printk("GC2145_Open, sensor_id:%x \n",sensor_id);
		if (sensor_id != GC2145_SENSOR_ID)
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	
		printk("GC2145 Sensor Read ID OK \r\n");
		GC2145_Sensor_Init();
...
{
    printk("[GC2145SetTestPatternMode]test pattern bEnable:=%d\n",bEnable);
    if(bEnable)
    {
	GC2145_write_cmos_sensor(0xfe, 0x00); 
	GC2145_write_cmos_sensor(0xb6, 0x00); 
