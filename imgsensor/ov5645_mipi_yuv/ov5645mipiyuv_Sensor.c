...
void OV5645MIPI_night_mode(kal_bool enable)
{
	...
	{   /* camera normal mode */                
		  ...
		  if(OV5645MIPISensor.zsd_flag==0)
	    {
			...
			OV5645MIPI_write_cmos_sensor(0x3a02,0x07);//08
      OV5645MIPI_write_cmos_sensor(0x3a03,0xb0);//12
      OV5645MIPI_write_cmos_sensor(0x3a14,0x07);//08
      OV5645MIPI_write_cmos_sensor(0x3a15,0xb0);//12	
		  }	
		  else
		  {
...
void OV5645MIPIInitialSetting(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x3611, 0x06);//06
  ...
  OV5645MIPI_write_cmos_sensor(0x3a19, 0xc0);//f8
  ...
  OV5645MIPI_write_cmos_sensor(0x3612, 0xab);//ab
  ...
  OV5645MIPI_write_cmos_sensor(0x5583, 0x44);//40
  OV5645MIPI_write_cmos_sensor(0x5584, 0x30);//20
  ...
  OV5645MIPI_write_cmos_sensor(0x5800, 0x23);//   2e
  OV5645MIPI_write_cmos_sensor(0x5801, 0x19);//   20
  OV5645MIPI_write_cmos_sensor(0x5802, 0x12);//   18
  OV5645MIPI_write_cmos_sensor(0x5803, 0x12);//   18
  OV5645MIPI_write_cmos_sensor(0x5804, 0x1a);//   20
  OV5645MIPI_write_cmos_sensor(0x5805, 0x28);//   3f
  OV5645MIPI_write_cmos_sensor(0x5806, 0xe );//   11
  OV5645MIPI_write_cmos_sensor(0x5807, 0x8 );//   0a
  OV5645MIPI_write_cmos_sensor(0x5808, 0x5 );//   08
  OV5645MIPI_write_cmos_sensor(0x5809, 0x6 );//   09
  OV5645MIPI_write_cmos_sensor(0x580a, 0x8 );//   0c
  OV5645MIPI_write_cmos_sensor(0x580b, 0x10);//   18
  OV5645MIPI_write_cmos_sensor(0x580c, 0x6 );//   09
  OV5645MIPI_write_cmos_sensor(0x580d, 0x3 );//   03
  OV5645MIPI_write_cmos_sensor(0x580e, 0x0 );//   01
  OV5645MIPI_write_cmos_sensor(0x580f, 0x1 );//   01
  OV5645MIPI_write_cmos_sensor(0x5810, 0x4 );//   05
  OV5645MIPI_write_cmos_sensor(0x5811, 0x7 );//   0e
  OV5645MIPI_write_cmos_sensor(0x5812, 0x6 );//   0a
  OV5645MIPI_write_cmos_sensor(0x5813, 0x3 );//   03
  OV5645MIPI_write_cmos_sensor(0x5814, 0x1 );//   01
  OV5645MIPI_write_cmos_sensor(0x5815, 0x1 );//   01
  OV5645MIPI_write_cmos_sensor(0x5816, 0x3 );//   06
  OV5645MIPI_write_cmos_sensor(0x5817, 0x7 );//   0f
  OV5645MIPI_write_cmos_sensor(0x5818, 0xb );//   10
  OV5645MIPI_write_cmos_sensor(0x5819, 0x6 );//   0a
  OV5645MIPI_write_cmos_sensor(0x581a, 0x4 );//   07
  OV5645MIPI_write_cmos_sensor(0x581b, 0x4 );//   08
  OV5645MIPI_write_cmos_sensor(0x581c, 0x6 );//   0d
  OV5645MIPI_write_cmos_sensor(0x581d, 0xd );//   16
  OV5645MIPI_write_cmos_sensor(0x581e, 0x1d);//   2e
  OV5645MIPI_write_cmos_sensor(0x581f, 0x14);//   1a
  OV5645MIPI_write_cmos_sensor(0x5820, 0xd );//   15
  OV5645MIPI_write_cmos_sensor(0x5821, 0xe );//   16
  OV5645MIPI_write_cmos_sensor(0x5822, 0x15);//   22
  OV5645MIPI_write_cmos_sensor(0x5823, 0x21);//   3d
  OV5645MIPI_write_cmos_sensor(0x5824, 0x2a);//   2a
  OV5645MIPI_write_cmos_sensor(0x5825, 0x2a);//   0c
  OV5645MIPI_write_cmos_sensor(0x5826, 0x4c);//   0e
  OV5645MIPI_write_cmos_sensor(0x5827, 0x2a);//   0c
  OV5645MIPI_write_cmos_sensor(0x5828, 0x28);//   26
  OV5645MIPI_write_cmos_sensor(0x5829, 0x2c);//   2c
  OV5645MIPI_write_cmos_sensor(0x582a, 0x28);//   28
  OV5645MIPI_write_cmos_sensor(0x582b, 0x26);//   24
  OV5645MIPI_write_cmos_sensor(0x582c, 0x28);//   26

  OV5645MIPI_write_cmos_sensor(0x582d, 0x2c);//   2a
  OV5645MIPI_write_cmos_sensor(0x582e, 0x2e);//   2c
  OV5645MIPI_write_cmos_sensor(0x582f, 0x42);//   42
  OV5645MIPI_write_cmos_sensor(0x5830, 0x40);//   40
  OV5645MIPI_write_cmos_sensor(0x5831, 0x22);//   42
  OV5645MIPI_write_cmos_sensor(0x5832, 0x2c);//   28
  OV5645MIPI_write_cmos_sensor(0x5833, 0x2e);//   2c
  OV5645MIPI_write_cmos_sensor(0x5834, 0x48);//   28
  OV5645MIPI_write_cmos_sensor(0x5835, 0x46);//   26
  OV5645MIPI_write_cmos_sensor(0x5836, 0x48);//   28
  OV5645MIPI_write_cmos_sensor(0x5837, 0x2c);//   2a
  OV5645MIPI_write_cmos_sensor(0x5838, 0x2c);//   48
  OV5645MIPI_write_cmos_sensor(0x5839, 0x2c);//   2c
  OV5645MIPI_write_cmos_sensor(0x583a, 0x2e);//   2e
  OV5645MIPI_write_cmos_sensor(0x583b, 0x2c);//   2c
  OV5645MIPI_write_cmos_sensor(0x583c, 0xa );//   44
  OV5645MIPI_write_cmos_sensor(0x583d, 0xce);//   ce
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x28);//18
	OV5645MIPI_write_cmos_sensor(0x5303, 0x18);//08
	OV5645MIPI_write_cmos_sensor(0x5306, 0x18);//0e
	OV5645MIPI_write_cmos_sensor(0x5307, 0x20);//1e
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x38);//18
	OV5645MIPI_write_cmos_sensor(0x5303, 0x28);//08
	...
	OV5645MIPI_write_cmos_sensor(0x380c, 0x0d);//0b
	OV5645MIPI_write_cmos_sensor(0x380d, 0xe0);//ec
	OV5645MIPI_write_cmos_sensor(0x380e, 0x09);//07
	OV5645MIPI_write_cmos_sensor(0x380f, 0xa4);//b0
...
static void OV5645_FOCUS_OVT_AFC_Constant_Focus(void)
{
	...
	mDELAY(10);
	OV5645MIPI_write_cmos_sensor(0x3024,0x28);
	OV5645MIPI_write_cmos_sensor(0x3025,0x1e);
	OV5645MIPI_write_cmos_sensor(0x3023,0x01);
...
UINT32 OV5645MIPIOpen(void)
{
  ...
  mDELAY(10);
	...
	OV5645MIPIInitialSetting();
if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_A2, VOL_1500,"kd_camera_hw"))
	{
		OV5645MIPISENSORDB("[OV5645MIPI] Fail to enable CAMERA_POWER_VCAM_A2\n");
	}
	mdelay(20);
...
UINT32 OV5645MIPIClose(void)
{
  ...
  lastadc = OV5645read_vcm_adc();
	...
	if(TRUE != hwPowerDown(CAMERA_POWER_VCAM_A2, "kd_camera_hw"))
	{
		...
		OV5645MIPISENSORDB("[OV5645MIPIOFILM] Fail to disable CAMERA_POWER_VCAM_A2\n");
	}
	return ERROR_NONE;
}	/* OV5645MIPIClose() */
/*************************************************************************
...
OV5645MIPI_IMAGE_SENSOR_SVGA_WIDTH-2*OV5645MIPI_PV_GRAB_START_X; 
