...
SP0A19_write_cmos_sensor(0xec,0x32);
SP0A19_write_cmos_sensor(0xe9,0x26);
SP0A19_write_cmos_sensor(0xed,0x32);
...
SP0A19_write_cmos_sensor(0xfd,0x01);
SP0A19_write_cmos_sensor(0xa0,0x66);
...
SP0A19_write_cmos_sensor(0xa8,0x90);
...
SP0A19_write_cmos_sensor(0xfd,0x00);
SP0A19_write_cmos_sensor(0xed,0x88);
SP0A19_write_cmos_sensor(0xf7,0x84);
SP0A19_write_cmos_sensor(0xf8,0x7c);
SP0A19_write_cmos_sensor(0xec,0x78);
...
SP0A19_write_cmos_sensor(0xd3,0x94);
SP0A19_write_cmos_sensor(0xd4,0x94);
SP0A19_write_cmos_sensor(0xd6,0x50);
SP0A19_write_cmos_sensor(0xd7,0x40);
SP0A19_write_cmos_sensor(0xfd,0x00);
...
SP0A19_write_cmos_sensor(0x5f,0x51);
	...
	SP0A19_write_cmos_sensor(0xe7,0x14); //rangek_neg_dummy
	SP0A19_write_cmos_sensor(0xd5,0x14); //rangek_pos_dummy
	SP0A19_write_cmos_sensor(0xd9,0x14); //range_base_dummy  

	SP0A19_write_cmos_sensor(0xd2,0x18); //rangek_neg_lowlight
	SP0A19_write_cmos_sensor(0xd6,0x18); //rangek_pos_lowlight
	SP0A19_write_cmos_sensor(0xda,0x18); //range_base_lowlight
#else
	...
	SP0A19_write_cmos_sensor(0xa8,0x90);//9a//9a
...
//ae target
	...
	SP0A19_write_cmos_sensor(0xef,0x70);//99
	SP0A19_write_cmos_sensor(0xf9,0x6c);//90
	SP0A19_write_cmos_sensor(0xfa,0x64);//80
	SP0A19_write_cmos_sensor(0xee,0x60);//78 
	#else
	//ae target
	SP0A19_write_cmos_sensor(0xfd,0x00); 
	...
	SP0A19_write_cmos_sensor(0xc1,0xd8);
	#if defined(PROJECT_M713_DRV_SUPPORT)
	SP0A19_write_cmos_sensor(0xd3,0x84);//0x78
	SP0A19_write_cmos_sensor(0xd4,0x84);//0x78
	SP0A19_write_cmos_sensor(0xd6,0x68);//0x78      
	SP0A19_write_cmos_sensor(0xd7,0x50);//0x78
	#else
	SP0A19_write_cmos_sensor(0xd3,0x8c);//0x78
	SP0A19_write_cmos_sensor(0xd4,0x88);//0x78
	SP0A19_write_cmos_sensor(0xd6,0x50);//0x78      
	SP0A19_write_cmos_sensor(0xd7,0x40);//0x78
	#endif
	//HEQ
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xdc,0x00);
