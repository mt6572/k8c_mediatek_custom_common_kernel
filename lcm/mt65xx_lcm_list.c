...
extern LCM_DRIVER nt35310_dsi_vdo_drv;
extern LCM_DRIVER s6d04d2x01_lcm_drv;

/* Added start by Eli at 2014-07-29 14:52  */
extern LCM_DRIVER ili9488_320x320_dsi_cmd_boe_lcm_drv;
LCM_DRIVER* lcm_driver_list[] = 
{ 
/* Added start by Eli at 2014-07-29 15:27  */
#if defined(S6D04D2X01)
    &s6d04d2x01_lcm_drv,
#endif

#ifdef ILI9488_320X320_DSI_CMD_BOE
        &ili9488_320x320_dsi_cmd_boe_lcm_drv,
#endif  /* ILI9488_320X320_DSI_CMD_BOE */
...
#endif
#if defined(NT35310_DSI_VDO)
      &nt35310_dsi_vdo_drv,
#endif
#if defined(ILI9488_DSI_VDO)
      &ili9488_lcm_drv,
#endif
};
